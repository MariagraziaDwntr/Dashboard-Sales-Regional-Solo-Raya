...
st.sidebar.markdown("---")
st.sidebar.caption(
    f"📁 SELL_IN.xlsx — update terakhir: {datetime.fromtimestamp(os.path.getmtime(SELL_IN_FILE)):%d %b %Y %H:%M}"
)
st.sidebar.caption(
    f"📁 SELLOUT.xlsx — update terakhir: {datetime.fromtimestamp(os.path.getmtime(SELLOUT_FILE)):%d %b %Y %H:%M}"
)
